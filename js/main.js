$(document).ready(function() {
  ...
  var createDivs = function() {
    ...
    p1Qp2R.append('<div class = "p2respBtn" id = "p2True">True</div>');
    p1Qp2R.append('<div class = "p2respBtn" id = "p2False">False</div>');
    p2Qp1R.append('<div class="display" id="p2Text"></div>');
    p2Qp1R.append('<div class = "p1respBtn" id = "p1True">True</div>');
    p2Qp1R.append('<div class = "p1respBtn" id = "p1False">False</div>');
    var choice = 0;
  ...
  var correctAnswer = function() {
    ...
    if (choice !== quizList[currentQuiz[currentIndex]].answer) {
      ...
      if (playTurn === 1) {
        p1Score += 1;
        $('#p1ScoreBoard').html("Player 1: " + p1Score);
        $('#p1Text').text('Correct!');
        playTurn = 2;
  ...
  var isGameOver = function() {
    if (currentIndex > (quizSize - 1)) {
      if (p1Score > p2Score) {
        alert('Player 1 wins with ' + p1Score + 'points');
        location.reload();
      } else if (p2Score > p1Score) {
        alert('Player 2 wins with ' + p2Score + 'points');
        location.reload();
